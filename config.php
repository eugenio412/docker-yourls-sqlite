...
define( 'YOURLS_SITE', getenv('YOURLS_SITE') ?: 'http://your.url' );
...
define( 'YOURLS_COOKIEKEY', getenv('YOURLS_COOKIEKEY') ?: 'copy string from website in Hint' );
...
define( 'YOURLS_URL_CONVERT', filter_var(getenv('YOURLS_URL_CONVERT'), FILTER_VALIDATE_INT) ?: 62 );
/*
